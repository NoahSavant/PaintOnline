(function(c) {
    function a(b, d) {
        if ({}.hasOwnProperty.call(a.cache, b))
            return a.cache[b];
        var e = a.resolve(b);
        if (!e)
            throw new Error('Failed to resolve module ' + b);
        var c = {
            id: b,
            require: a,
            filename: b,
    ...
    a.define('/gif.coffee', function(b, k, j, i) {
        function c(a, b) {
        ...
        var e, d, f;
        d = a('events', b).EventEmitter,
        e = a('/browser.coffee', b),
        f = function(f, b, d) {
            function a(d) {
                var a, c;
                this.running = !1,
                ...
                for (a in b)
                    c = b[a],
                    null != this.options[a] ? this.options[a] : this.options[a] = c
            }
            return h(a, f),
            b = {
            ...
            ,
            a.prototype.addFrame = function(a, c) {
                var b, e;
                null == c && (c = {}),
                b = {};
                for (e in d)
                    b[e] = c[e] || d[e];
                if (null != this.options.width || this.setOption('width', a.width),
                ...
                'undefined' !== typeof ImageData && null != ImageData && a instanceof ImageData)
                    ...
                    c.copy ? b.data = this.getContextData(a) : b.context = a;
                else if (null != a.childNodes)
                    c.copy ? b.data = this.getImageData(a) : b.image = a;
                else
            ...
            a.prototype.render = function() {
                ...
                this.imageParts = function(c) {
                    ...
                    for (var b = function() {
                        var b;
                        b = [];
                        for (var a = 0; 0 <= this.frames.length ? a < this.frames.length : a > this.frames.length; 0 <= this.frames.length ? ++a : --a)
                            b.push(a);
                        return b
                    }
                    .apply(this, arguments), a = 0, d = b.length; a < d; ++a)
                        e = b[a],
                        c.push(null);
                    return c
                }
                ...
                .apply(this, arguments), b = 0, d = c.length; b < d; ++b)
                    e = c[b],
            ...
            a.prototype.spawnWorkers = function() {
                ...
                .apply(this, arguments).forEach(function(a) {
                    return function(c) {
                        var b;
                        return console.log('spawning worker ' + c),
                        b = new Worker(a.options.workerScript),
                        b.onmessage = function(a) {
                            return function(c) {
                                return a.activeWorkers.splice(a.activeWorkers.indexOf(b), 1),
            ...
            a.prototype.frameFinished = function(a) {
                return console.log('frame ' + a.index + ' finished - ' + this.activeWorkers.length + ' active'),
                this.finishedFrames++,
            ...
            a.prototype.finishRendering = function() {
                ...
                for (var f = 0, j = this.imageParts.length; f < j; ++f)
                    a = this.imageParts[f],
                    b += (a.data.length - 1) * a.pageSize + a.cursor;
            ...
            a.prototype.renderNextFrame = function() {
                ...
                return this.nextFrame >= this.frames.length ? void 0 : (c = this.frames[this.nextFrame++],
            ...
            a.prototype.getTask = function(a) {
                ...
                b = {
                    ...
                    canTransfer: e.name === 'chrome'
                },
                null != a.data)
                    b.data = a.data;
                else if (null != a.context)
                    b.data = this.getContextData(a.context);
                else if (null != a.image)
                    b.data = this.getImageData(a.image);
                else
    ...
    a.define('/browser.coffee', function(f, g, h, i) {
        ...
        b = c.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/) || [null, 'unknown', 0],
    ...
    a.define('events', function(f, e, g, h) {
        ...
        a.prototype.emit = function(f) {
            if (f === 'error' && (!(this._events && this._events.error) || c(this._events.error) && !this._events.error.length))
        ...
        a.prototype.addListener = function(a, b) {
            ...
            !this._events[a])
                ...
                if (!this._events[a].warned) {
                    ...
                    e && e > 0 && this._events[a].length > e && (this._events[a].warned = !0,
        ...
        a.prototype.removeListener = function(a, d) {
            ...
            if (c(b)) {
                ...
                if (e < 0)
                    return this;
                b.splice(e, 1),
                b.length == 0 && delete this._events[a]
            } else
        ...
        a.prototype.removeAllListeners = function(a) {
            return a && this._events && this._events[a] && (this._events[a] = null),
            this
        }
        ,
