    ...
    1: [function(require, module, exports) {
        ...
        (function(exports) {
            ...
            fontAvailabilityChecker = (function() {
                ...
                return {
                    init: function() {
                        ...
                        results = [];
                        for (j = 0,
                        len = baseFontFamilies.length; j < len; j++) {
            ...
            loadFonts = function() {
                ...
                fallback = function() {
                    ...
                    return testFonts((function() {
                        ...
                        results = [];
                        for (j = 0,
                        len = someCommonFontNames.length; j < len; j++) {
                        ...
                        return interval = every(50, function() {
                            ...
                            if (swf.fonts) {
                                ...
                                return testFonts((function() {
                                    ...
                                    len = ref.length; j < len; j++) {
                                        ref1 = ref[j],
                                        fontName = ref1.fontName,
                                        fontType = ref1.fontType,
                                        fontStyle = ref1.fontStyle;
            ...
            FD.each = function(callback) {
                var font, j, len;
                for (j = 0,
                len = testedFonts.length; j < len; j++) {
                    font = testedFonts[j];
                    callback(font);
                }
                if (!doneTestingFonts) {
