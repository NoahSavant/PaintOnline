function $Handles($container, element, options) {
    ...
    var get_offset_left = options.get_offset_left || function() {
        return 0;
    }
    ;
    var get_offset_top = options.get_offset_top || function() {
        return 0;
    }
    ;
    ...
    var handles = $.map([["top", "right"], ["top", "middle"], ["top", "left"], ["middle", "left"], ["bottom", "left"], ["bottom", "middle"], ["bottom", "right"], ["middle", "right"], ], function(pos) {
        var y_axis = pos[0];
        var x_axis = pos[1];
        ...
        var update_handle = function() {
            ...
            if (x_axis === "middle") {
                $h.css({
                    left: get_offset_left() + (rect.width - hs) / 2
                });
            } else if (x_axis === "left") {
                $h.css({
            ...
            if (y_axis === "middle") {
                $h.css({
                    top: get_offset_top() + (rect.height - hs) / 2
                });
            } else if (y_axis === "top") {
                $h.css({
