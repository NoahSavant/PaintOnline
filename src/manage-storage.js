...
function storage_quota_exceeded() {
    ...
    $w.$main.html("<p>JS Paint stores images as you work on them so that if you " + "close your browser or tab or reload the page " + "your images are usually safe.</p>" + "<p>However, it has run out of space to do so.</p>" + "<p>You can still save the current image with <b>File > Save</b>. " + "You should save frequently, or free up enough space to keep the image safe.</p>");
...
function manage_storage() {
    ...
    var $message = $(E("p")).appendTo($storage_manager.$main).html("Any images you've saved to your computer with <b>File > Save</b> will not be affected.");
    ...
    var addRow = function(k, imgSrc) {
        ...
        var $open_link = $(E("a")).attr({
            href: href,
            target: "_blank"
        }).text("Open");
        var $thumbnail_open_link = $(E("a")).attr({
            href: href,
            target: "_blank"
